        ...
        <AnimatePresence mode="wait">
          ...
          {showHighSchoolExamMode && (
            <motion.div key="exam-mode" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-8">
              ...
              {/* الجداول والنماذج في وضع التركيز */}
          ...
          {showRegularDashboard && (
             <motion.div key="regular-mode" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="grid grid-cols-1 lg:grid-cols-12 gap-8 no-print">
                ...
                {warningLevel > 0 && (
                  <div className={`relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] glass-panel p-6 sm:p-8 shadow-[0_0_40px_rgba(0,0,0,0.5)] ${warningColors}`}>
                ...
                {(nextOfficialExam) && (
                    <div className="relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] glass-panel p-6 sm:p-8 border-rose-500/20 flex flex-col md:flex-row gap-6 items-center justify-between text-center md:text-right group">
