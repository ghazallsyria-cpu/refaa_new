...
import { 
  ...
  Pin, Lock, User, Clock, Send, XCircle, ShieldCheck, GraduationCap, BookOpen // 🚀 تم إضافة BookOpen هنا
} from 'lucide-react';
            ...
            {filteredTopics.map((topic) => {
              ...
              <Link key={topic.id} href={`/forums/topic/${topic.id}`} className="block hover:bg-slate-50 transition-colors group p-5 sm:p-6">
                <div className="flex items-start gap-4">
                  {/* 🚀 عرض الصورة الشخصية أو الأيقونة */}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-[10px] sm:text-xs">
                      ...
                      {/* 🚀 أوسمة الإنجازات (Gamification Badges) */}
