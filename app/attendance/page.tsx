...
const ATTENDANCE_OPTIONS = [
  { 
    ...
    label: 'حاضر',
    mobileLabel: 'حاضر',
    peerClasses: 'peer-checked:border-emerald-500 peer-checked:bg-emerald-50 peer-checked:text-emerald-700 peer-checked:shadow-emerald-100 group-hover/radio:border-emerald-200 group-hover/radio:bg-emerald-50',
    activeClasses: 'bg-emerald-50 border-emerald-500 text-emerald-700 shadow-md shadow-emerald-100',
    inactiveClasses: 'bg-white border-slate-100 text-slate-400 hover:border-emerald-200'
  },
  { 
    status: 'absent', 
    icon: XCircle, 
    label: 'غائب',
    mobileLabel: 'غائب',
    peerClasses: 'peer-checked:border-rose-500 peer-checked:bg-rose-50 peer-checked:text-rose-700 peer-checked:shadow-rose-100 group-hover/radio:border-rose-200 group-hover/radio:bg-rose-50',
    activeClasses: 'bg-rose-50 border-rose-500 text-rose-700 shadow-md shadow-rose-100',
    inactiveClasses: 'bg-white border-slate-100 text-slate-400 hover:border-rose-200'
  },
  { 
    status: 'late', 
    icon: Clock, 
    label: 'متأخر',
    mobileLabel: 'تأخر',
    peerClasses: 'peer-checked:border-amber-500 peer-checked:bg-amber-50 peer-checked:text-amber-700 peer-checked:shadow-amber-100 group-hover/radio:border-amber-200 group-hover/radio:bg-amber-50',
    activeClasses: 'bg-amber-50 border-amber-500 text-amber-700 shadow-md shadow-amber-100',
    inactiveClasses: 'bg-white border-slate-100 text-slate-400 hover:border-amber-200'
  },
  { 
    status: 'excused', 
    icon: AlertCircle, 
    label: 'مستأذن',
    mobileLabel: 'عذر',
    peerClasses: 'peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:text-blue-700 peer-checked:shadow-blue-100 group-hover/radio:border-blue-200 group-hover/radio:bg-blue-50',
    activeClasses: 'bg-blue-50 border-blue-500 text-blue-700 shadow-md shadow-blue-100',
    inactiveClasses: 'bg-white border-slate-100 text-slate-400 hover:border-blue-200'
  }
];
