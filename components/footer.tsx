      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-amber-400 to-yellow-600 p-[1px] shadow-[0_0_20px_rgba(245,158,11,0.2)] relative group cursor-default">
              <div className="absolute inset-0 bg-amber-500 opacity-0 group-hover:opacity-40 blur-md transition-opacity duration-500 rounded-2xl" />
              <div className="w-full h-full bg-[#0f1423] backdrop-blur-md rounded-2xl flex items-center justify-center relative z-10">
                <Code2 className="h-6 w-6 text-amber-500 group-hover:text-amber-400 transition-colors duration-300 drop-shadow-[0_0_5px_rgba(245,158,11,0.5)]" />
              </div>
            </div>
            
            <div className="flex flex-col">
              <h3 className="text-white font-black text-lg sm:text-xl tracking-tight flex items-center gap-2 drop-shadow-md">
                إيهاب جمال غزال
          ...
          <div className="flex flex-col items-center md:items-end gap-3">
            ...
            <div className="flex items-center gap-2 bg-[#0f1423]/80 px-5 py-2.5 rounded-full border border-white/5 shadow-inner backdrop-blur-md hover:border-amber-500/30 transition-colors">
