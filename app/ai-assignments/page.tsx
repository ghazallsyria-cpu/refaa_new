...
تعليمات هامة جداً:
1. الهيكلية (الرئيسي والفرعي): إذا كان المحتوى يحتوي على "قطعة قراءة"، أو "رأس مسألة فيزيائية/كيميائية شاملة" يتبعها عدة طلبات، قم بإنشاء عنصر مستقل من نوع "section_header" يحتوي على معطيات المسألة أو القطعة، ثم أتبعه بالأسئلة الفرعية.
2. الرموز العلمية (رياضيات، فيزياء، كيمياء): يجب وضع جميع الأرقام، الرموز، الدرجات المئوية، والمعادلات بين علامتي دولار $ للمعادلات المضمنة (مثال: $H_2O$ أو $100^\\circ \\text{C}$ أو $C = 5 \\mu\\text{F}$) وبين علامتي $$ للمعادلات المستقلة.
3. التنسيق الآمن للـ JSON: لضمان سلامة الكود، يجب وضع شرطتين مائلتين (\\\\) قبل أي رمز LaTeX (مثال: اكتب \\\\mu بدلاً من \\mu، واكتب \\\\circ بدلاً من \\circ).
4. إذا كان هناك "إجابة نموذجية"، ادمجه في نهاية نص السؤال هكذا: [الإجابة النموذجية للمعلم: ...]
5. أنواع الأسئلة المسموحة فقط: multiple_choice أو true_false أو essay أو section_header.
6. يجب أن يكون الناتج بتنسيق JSON حصرياً وصالحاً بالهيكل التالي بالضبط:
{
  "title": "عنوان الواجب",
  "questions": [
    {
      "content": "نص القطعة أو رأس المسألة الشاملة هنا",
      "type": "section_header",
      "points": 0,
      "options": []
    },
    {
      "content": "نص السؤال الفرعي الأول؟ [الإجابة النموذجية للمعلم: ...]",
      "type": "essay",
      "points": 1,
      "options": []
    }
