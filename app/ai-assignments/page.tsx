...
// 🚀 البرومبت الشامل (يجمع قواعد الكيمياء العضوية، الفيزياء، والحل الجذري لأقواس الرياضيات)
...
🛑 2. قواعد الرياضيات العربية والفيزياء (حرج جداً لمنع تشوه الأقواس):
- يُمنع منعاً باتاً وضع الأقواس العادية () أو علامات + و - داخل علامات الدولار $ إذا كانت بجوار نصوص عربية. افصل كل حد رياضي داخل دولار $ لوحده وضع الأقواس خارجه.
  ✔️ صحيح (أقواس في الخارج): ( $س^٢$ + $٢$ ) - $٢٥$ ( $س$ + $٢$ )
  ❌ خطأ (يُشوه النص): $(س^٢ + ٢) - ٢٥(س + ٢)$
- في الفيزياء، اكتب أوامر LaTeX مع وضع شرطة مائلة إضافية للهروب البرمجي (Escaping) الخاص بـ JSON.
