...
export default function StudentDashboard() {
  ...
  const handlePrintTicket = async () => {
    ...
    try {
      ...
      // إنشاء ملف PDF أبعاده تطابق حجم البطاقة المدنية (85x55 ملم)
  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="min-h-screen bg-[#02040a] text-slate-100 pb-32 pt-6 font-sans no-print" dir="rtl">
      ...
      <AnimatePresence>
        {isPrinting && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-[#02040a]/90 backdrop-blur-md z-[200] flex flex-col items-center justify-center text-white no-print">
