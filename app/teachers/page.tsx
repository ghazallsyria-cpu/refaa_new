              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2 bg-amber-50/50 p-6 rounded-3xl border border-amber-100 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <label htmlFor="isHOD" className="font-black text-sm text-slate-800 cursor-pointer select-none">تعيين كرئيس قسم (يمنح صلاحيات إشرافية)</label>
                  </div>
                  {editForm.isHOD && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm" dir="rtl">
          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white w-full max-w-md rounded-[2.5rem] p-8 text-center shadow-2xl border border-slate-100">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => { setShowPasswordResetModal(false); setResetPasswordForm({ userId: '', newPassword: '' }); }} className="flex-1 bg-white border border-slate-200 text-slate-600 py-4 rounded-2xl font-black hover:bg-slate-50 transition-all">إلغاء</button>
            </div>
          </motion.div>
        </div>
      )}
