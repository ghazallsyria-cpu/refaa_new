  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-gray-50 to-indigo-50 p-4 md:p-8 font-sans" dir="rtl">
      ...
      {loading ? (
        ...
        <>
          {/* 🎪 منصة التتويج الماسية الذكية للثلاثة الأوائل */}
            ...
            {students[1] && (
              <div className="order-2 md:order-1 w-full md:w-1/3 flex flex-col items-center transform transition hover:-translate-y-2">
                <div className="bg-white/50 backdrop-blur-lg border-[2px] border-gray-300 shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-t-3xl rounded-b-xl p-6 w-full text-center relative overflow-hidden">
                  ...
                  {/* دائرة الصورة أو الأيقونة الفضية */}
                  <div className="w-20 h-20 mx-auto rounded-full flex items-center justify-center text-3xl shadow-inner mb-4 ring-4 ring-gray-200 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-300 relative">
                  ...
                  <h3 className="text-xl font-bold text-gray-800 mb-2 truncate">{students[1].student_name}</h3>
                  <p className="text-gray-500 mb-4 text-sm">المركز الثاني</p>
                  <div className="inline-block bg-gray-100 text-gray-800 px-4 py-1.5 rounded-full font-bold text-sm">
            ...
            {students[0] && (
              <div className="order-1 md:order-2 w-full md:w-1/3 flex flex-col items-center transform transition hover:-translate-y-3 z-10">
                <div className="bg-white/60 backdrop-blur-xl border-[2px] border-yellow-400 shadow-[0_10px_40px_rgba(250,204,21,0.2)] rounded-t-3xl rounded-b-xl p-8 w-full text-center relative overflow-hidden">
                  ...
                  {/* دائرة الصورة أو التاج الذهبي */}
                  <div className="w-24 h-24 mx-auto rounded-full flex items-center justify-center text-4xl shadow-inner mb-4 ring-4 ring-yellow-100 overflow-hidden bg-gradient-to-br from-yellow-300 to-yellow-500 relative">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-2 truncate">{students[0].student_name}</h3>
                  <p className="text-yellow-600 font-bold mb-4 text-sm">المركز الأول</p>
            ...
            {students[2] && (
              <div className="order-3 md:order-3 w-full md:w-1/3 flex flex-col items-center transform transition hover:-translate-y-2">
                <div className="bg-white/50 backdrop-blur-lg border-[2px] border-amber-600/40 shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-t-3xl rounded-b-xl p-6 w-full text-center relative overflow-hidden">
                  ...
                  {/* دائرة الصورة أو الأيقونة البرونزية */}
                  <div className="w-16 h-16 mx-auto rounded-full flex items-center justify-center text-2xl shadow-inner mb-4 ring-4 ring-amber-100 overflow-hidden bg-gradient-to-br from-amber-200 to-amber-500 relative">
                  ...
                  <h3 className="text-xl font-bold text-gray-800 mb-2 truncate">{students[2].student_name}</h3>
                  <p className="text-gray-500 mb-4 text-sm">المركز الثالث</p>
                  <div className="inline-block bg-amber-50 text-amber-800 px-4 py-1.5 rounded-full font-bold text-sm">
          ...
          {/* 📜 سجل كوكبة المتفوقين (المراكز من ٤ فما فوق) */}
            ...
            {students.slice(3).map((student, index) => (
              <div key={student.id} className="flex items-center justify-between bg-white/40 backdrop-blur-md border border-white/60 p-4 rounded-2xl shadow-[0_4px_16px_0_rgba(31,38,135,0.03)] hover:bg-white/60 transition duration-300">
                <div className="flex items-center gap-4">
                  ...
                  {/* الصورة المصغرة في القائمة السفلى */}
                  {student.image_url ? (
                    <img src={student.image_url} alt="" className="w-10 h-10 rounded-full object-cover border border-gray-200 shadow-sm" />
                  ) : (
                    <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-lg shadow-inner">🎓</div>
                  )}
